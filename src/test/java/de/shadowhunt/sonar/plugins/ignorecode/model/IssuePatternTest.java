...
public class IssuePatternTest {
    ...
    @Test
    public void addLine() {
        final IssuePattern vp = new IssuePattern("resourcePattern", "rulePattern");
        vp.addLine(1);
        vp.addLine(3);
        vp.addLine(5);
    ...
    public void parse() throws IOException {
        ...
        try {
            ...
            final IssuePattern vp = lines.get(0);
    ...
    public void parseLineMixed() {
        final IssuePattern vp = IssuePattern.parseLine("resourcePattern;rulePattern;[2,4-6]");
        Assert.assertEquals("resourcePattern name must match", "resourcePattern", vp.getResourcePattern());
        Assert.assertEquals("rulePattern name must match", "rulePattern", vp.getRulePattern());
    ...
    public void parseLineRange() {
        final IssuePattern vp = IssuePattern.parseLine("resourcePattern;rulePattern;[2-6]");
        Assert.assertEquals("resourcePattern name must match", "resourcePattern", vp.getResourcePattern());
        Assert.assertEquals("rulePattern name must match", "rulePattern", vp.getRulePattern());
    ...
    public void parseLineSingle() {
        final IssuePattern vp = IssuePattern.parseLine("resourcePattern;rulePattern;[2]");
        Assert.assertEquals("resourcePattern name must match", "resourcePattern", vp.getResourcePattern());
        Assert.assertEquals("rulePattern name must match", "rulePattern", vp.getRulePattern());
    ...
    public void parseLineValueCombined() {
        final IssuePattern vp = IssuePattern.parseLineValues("resourcePattern", "rulePattern", "[1,3,5-7]");
        Assert.assertNotNull("IssuePattern must not be null", vp);
        Assert.assertEquals("resourcePattern name must match", "resourcePattern", vp.getResourcePattern());
        Assert.assertEquals("rulePattern name must match", "rulePattern", vp.getRulePattern());
    ...
    public void parseLineValuesAllLines() {
        final IssuePattern linePattern = IssuePattern.parseLineValues("resourcePattern", "rulePattern", "*");
        Assert.assertNotNull("IssuePattern must not be null", linePattern);
    ...
    public void parseLineValuesRange() {
        final IssuePattern linePattern = IssuePattern.parseLineValues("resourcePattern", "rulePattern", "[2-6]");
        Assert.assertNotNull("IssuePattern must not be null", linePattern);
    ...
    public void parseLineValuesSingle() {
        final IssuePattern linePattern = IssuePattern.parseLineValues("resourcePattern", "rulePattern", "[2]");
        Assert.assertNotNull("IssuePattern must not be null", linePattern);
